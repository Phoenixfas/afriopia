...
export default function NavBar() {
  ...
  return (
    <div className={`${style.navbar} ${toggle && style.navToggled} ${toggle && route==="/events" ? style.navbarEvent : null}`} >
        <div className={style.navbar__left}>
            <Image src={`${"/images/Logo.svg"}`} alt="Logo" width={60} height={60} />
            <Link href="/"><p>afri<span>opia</span></p></Link>
        </div>
        <div className={`${style.navbar__right} ${route==="/events" ? style.navbar__rightEvent : null}`}>
            <Link href="/">HOME</Link>
            ...
            <Link href="/contact-us" ><p className={`${style.contact} ${route==="/events" ? style.contact__Event : null}`}>CONTACT US</p></Link>
        </div>
        <div className={style.navbar__mobile}>
          {show ? <CgClose onClick={handleButton} color={route==="/events" ? "#050752" : "#073703"} size={toggle ? 30 : 35} /> : <CgMenuRight onClick={handleButton} color={route==="/events" ? "#050752" : "#073703"} size={toggle ? 30 : 35} />}
        </div>
        <div className={`${show ? style.nav__drawer : style.invisible}`}>
            ...
            <Link href="/contact-us" ><p onClick={handleButton} className={`${style.contact} ${route==="/events" ? style.contact__Event : null}`}>CONTACT US</p></Link>
        </div>
