...
const variants2 = {
  visible: { opacity: 1, x: 0, transition: { delay: .3, duration: .1, type: "spring", stiffness: 150} },
  hidden: { opacity: 0, x: 100, transition: { duration: .5, } }
}
const variants3 = {
  visible: { opacity: 1, x: 0, transition: { delay: .5, duration: .2, type: "spring", stiffness: 150} },
  hidden: { opacity: 0, x: 100, transition: { duration: .5, } }
}
